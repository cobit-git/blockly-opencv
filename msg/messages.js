...
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv image blocks.
Blockly.Msg.CV_IMAGE_HUE = '210';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv video blocks.
Blockly.Msg.CV_VIDEO_HUE = '120';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv figure blocks.
Blockly.Msg.CV_FIGURE_HUE = '230';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv basic operation blocks.
Blockly.Msg.CV_BASIC_OP_HUE = '160';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv image operation blocks.
Blockly.Msg.CV_IMAGE_OP_HUE = '260';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv image processing blocks.
Blockly.Msg.CV_IMAGE_PRO_HUE = '20';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv image threshold blocks.
Blockly.Msg.CV_IMAGE_THRE_HUE = '330';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv image transaction blocks.
Blockly.Msg.CV_IMAGE_TRAN_HUE = '310';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv image morph blocks.
Blockly.Msg.CV_IMAGE_MORP_HUE = '290';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv edge detect blocks.
Blockly.Msg.CV_EDGE_DETECT_HUE = '210';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv image contour blocks.
Blockly.Msg.CV_IMAGE_CONT_HUE = '80';
/** @type {string} */
/// {{Notranslate}} Hue value for all opencv contour feature blocks.
...
/** @type {string} */
/// OpenCV python code image.shape 
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV image.shape
...
/// OpenCV video block 
/** @type {string} */
/// OpenCV python code for VideoCapture() camera
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV VideoCapture() camera 
Blockly.Msg.CV_CREATE_CAPTURE_CAM_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for VideoCapture() file
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV VideoCapture() file 
Blockly.Msg.CV_CREATE_CAPTURE_FILE_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for read image from capture
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV VideoCapture() URL 
Blockly.Msg.CV_VIDEO_CAPTURE_URL_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for cap.set()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cap.set() 
Blockly.Msg.CV_SET_WID_HEI_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for videowriter() videowriter_fourcc()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV videowriter() videowriter_fourcc()
Blockly.Msg.CV_VIDEO_WRITER_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for videowriter.writer()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV videowriter.write()
Blockly.Msg.CV_VIDEO_WRITER_WR_HELPURL = 'http://cobit.kr'


/// OpenCV figure(draw) block 
/** @type {string} */
/// OpenCV python code for cv2.line()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.line()
Blockly.Msg.CV_DRAW_LINE__HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for cv2.rectangle()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.rectangle()
Blockly.Msg.CV_DRAW_RECT_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for cv2.circle()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.putText()
Blockly.Msg.CV_DRAW_PUT_TEXT_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for origin point(tuple) for text
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV origin point(tuple) for text input
Blockly.Msg.CV_DRAW_TEXT_ORG_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for create black image using numpy
...
/** @type {string} */
/// {{Optional}} url - A link that create black color image using numpy 
Blockly.Msg.CV_DRAW_CREATE_B_IMAGE_HELPURL = 'http://cobit.kr'

/// OpenCV basic operation blocks ----------------------------------------------- //

/** @type {string} */
/// OpenCV python code for get pixel RGB info 
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV get pixel RGB info 
Blockly.Msg.CV_BASIC_GET_PINFO_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code for change pxiel value 
...
/** @type {string} */
/// OpenCV python code for copy ROI to image 
...
/** @type {string} */
/// {{Optional}} url - A link that copy ROI to image 
Blockly.Msg.CV_BASIC_COPY_ROI_HELPURL = 'http://cobit.kr'

/// OpenCV image operation blocks ----------------------------------------------- //

/** @type {string} */
/// OpenCV python code cv2.add() 
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.add()
Blockly.Msg.CV_ADD_IMAGE_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code cv2.bitwise_not()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.bitwise_not()
Blockly.Msg.CV_BITWISE_NOT_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code cv2.bitwise_and()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.bitwise_and()
Blockly.Msg.CV_BITWISE_OR_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code cv2.bitwise_or()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.bitwise_or()
Blockly.Msg.CV_BITWISE_OR_HELPURL = 'http://cobit.kr'

/// OpenCV image processing  blocks  ----------------------------------------------- //
/** @type {string} */
/// OpenCV python code cv2.cvtColor()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.cvtColor()
Blockly.Msg.CV_CVT_COLOR_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code cv2.inRange()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.inRange()
Blockly.Msg.CV_IN_RANGE_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code upper limit for cv2.inRange()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV HSV upper limit value for cv2.inRange() function  
Blockly.Msg.CV_UPPER_LIMIT_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code lower limit for cv2.inRange()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV HSV lower limit value for cv2.inRange() function  
Blockly.Msg.CV_LOWER_LIMIT_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code get hue value
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV get hue value
Blockly.Msg.CV_GET_HUE_VALUE_HELPURL = 'http://cobit.kr'

/// OpenCV image threshold  blocks  ----------------------------------------------- //

// OpenCV image threshold block
/** @type {string} */
...
/// OpenCV image transformation block  blocks  ----------------------------------------------- //

// OpenCV image transformation blocks
/** @type {string} */
/// OpenCV python code cv2.flip()
Blockly.Msg.CV_TRANS_FLIP =  'Flip image %1 direction %2 save to %3';
/** @type {string} */
/// OpenCV cv2.flip() option - 
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.resize() 
Blockly.Msg.CV_TRANS_FLIP_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code cv2.resize()
...
/** @type {string} */
/// OpenCV python code for cv2.warpAffine() with 2D move matrix 
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.warpAffine() with 2D move matrix  
Blockly.Msg.CV_TRANS_MOVE_IMG_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code for cv2.warpAffine() cv2.getRotationMatrix2D() 
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.warpAffine() cv2.getRotationMatrix2D()  
Blockly.Msg.CV_TRANS_ROT_IMG_HELPURL = 'http://cobit.kr'

/// OpenCV image morphing  blocks  ----------------------------------------------- //

// OpenCV Morphing blocks 
/** @type {string} */
/// OpenCV python code for cv2.dilate()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.dilate()  
Blockly.Msg.CV_MORPH_DILATION_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for cv2.erode()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.morpholoyEx()()  
Blockly.Msg.CV_MORPH_MORPHEX_HELPURL = 'http://cobit.kr'

/// OpenCV edge detect  blocks  ----------------------------------------------- //

// OpenCV edge detect blocks 
/** @type {string} */
/// OpenCV python code for cv2.Canny()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.findContour()  
Blockly.Msg.CV_FIND_CONTOUR_HELPURL = 'http://cobit.kr'

/** @type {string} */
/// OpenCV python code for cv2.drawContour()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.drawContour()  
Blockly.Msg.CV_DRAW_CONTOUR_HELPURL = 'http://cobit.kr'


/// OpenCV image contour  feature blocks  ----------------------------------------------- //

// OpenCV contour feature blocks 
/** @type {string} */
/// OpenCV python code for getting contour center 
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV get contour center 
Blockly.Msg.CV_CON_FEATURE_CENTER_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for cv2.contourArea
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.arcLength()
Blockly.Msg.CV_CON_FEATURE_PERI_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for cv2.approxPolyDP()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.approxPolyDP)_
Blockly.Msg.CV_CON_FEATURE_APPROX_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for cv2.convexHull()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.convexHull()
Blockly.Msg.CV_CON_FEATURE_CONHULL_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for cv2.boundingRect() cv2.rectangle
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.boundingRect() cv2.rectangle
Blockly.Msg.CV_CON_FEATURE_BOUNDING_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for  cv2.minAreaRect cv2.boxPoints, cv2.drawContour()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.minAreaRect cv2.boxPoints, cv2.drawContour()
Blockly.Msg.CV_CON_FEATURE_MIN_RECT_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for   cv2.minEnclosingCircle() cv2.circle
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.minEnclosingCircle() cv2.circle
Blockly.Msg.CV_CON_FEATURE_MIN_CIRCLE_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for   cv2.fillEllipse cv2.ellipse()
...
/** @type {string} */
/// {{Optional}} url - A link that OpenCV cv2.fillEllipse cv2.ellipse()
Blockly.Msg.CV_CON_FEATURE_FIT_ELLIPSE_HELPURL = 'http://cobit.kr'
/** @type {string} */
/// OpenCV python code for   Get extream points
